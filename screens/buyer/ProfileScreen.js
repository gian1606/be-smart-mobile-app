      ...
      <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
        ...
        <View style={styles.statsRow}>
          {[
            ...
            { label: 'Bids Won',        value: mockBuyerUser.completedReservations },
          ].map((stat) => (
...
const styles = StyleSheet.create({
  ...
  roleBadge: { backgroundColor: colors.buyerLight, borderWidth: 1, borderColor: colors.buyerPrimary, borderRadius: 9999, paddingHorizontal: 12, paddingVertical: 4 },
  roleText: { fontSize: typography.size.xs, color: colors.buyerPrimary, fontWeight: typography.weight.semibold },
